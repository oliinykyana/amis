    ...
    public partial class bookingForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (reg_completed)
            {
                ...
                int n = FindBookNum();
                AddBooking(name1.Text, name2.Text, citizenship.Text, g, passnum.Text,s ,n);
        ...
        {
            string queryString =
                 "SELECT B_NUM FROM " + f1.username.Trim() + ".BOOKED_FLIGHT";
            int i = 0;
        ...
        public void AddBooking( string first, string last, string citizen, string gender, string pass, string val, int b_num)
        {
